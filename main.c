...
if (event.motion.x>163 && event.motion.x<=535 && event.motion.y>330 && event.motion.y<=425)
	...
	else if (event1.motion.x>1068 && event1.motion.x<=1146 && event1.motion.y>690 && event1.motion.y<=778)
	{			
...
case SDL_MOUSEMOTION :
	 if (event1.motion.x>1068 && event1.motion.x<=1146 && event1.motion.y>690 && event1.motion.y<=778)
{	
	i6=1;
	afficher(B11,screen);
	Mix_PlayChannel(-1,son,0);
